import { BsFacebook, BsYoutube, BsGoogle } from 'react-icons/bs';
...
const Footer = () => {
    ...
    return (
        <footer data-aos="zoom-out-up" className="footer footer-center p-10 bg-blue-500 md:bg-green-600 text-white text-primary-content">
            <aside>
                ...
                <p className="font-bold">
                    CARGOMATIC Techno Ltd. <br />Providing reliable techno event management since 2012
                </p>
                <p>Copyright © 2023 - All right reserved</p>
            </aside>
            <nav>
                <div className="grid grid-flow-col gap-4">
                    <a href="https://www.facebook.com/"><BsFacebook className='w-[30px] h-[30px]'></BsFacebook></a>
                    <a href="https://www.youtube.com/"><BsYoutube className='w-[30px] h-[30px]'></BsYoutube></a>
                    <a href='https://www.google.com/'><BsGoogle className='w-[30px] h-[30px]'></BsGoogle></a>
                </div>
            </nav>
        </footer>
    );
